...
/*   Updated: 2024/07/05 11:45:42 by jtollena         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	key_pressed(int key, t_data *data)
{
	if (key == KEY_W)
		...
		data->player.downing_pitch_key = ulimitor(23 - data->player.sensivity, 1);
	else if (key == KEY_DOWN)
		data->player.upping_pitch_key = ulimitor(23 - data->player.sensivity, 1);
}
...
int	key_released(int key, t_data *data)
{
	if (key == KEY_W)
		...
		data->player.downing_pitch_key = 0;
	else if (key == KEY_DOWN)
		data->player.upping_pitch_key = 0;
	return (0);
}
